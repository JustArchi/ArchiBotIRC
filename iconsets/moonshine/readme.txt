===============================================================================
 Moonshine Icon Collection
-------------------------------------------------------------------------------
 Copyright ©2002 Greg Fleming of Dark Project Studios.
===============================================================================

	ICON PACK NAME:         Moonshine
        DATE RELEASED:          11/10/2002
...
Moonshine is a complete system replacement set, designed to change the look of all
the icons on your system; Your desktop, start menu, folders, drives, files etc...

They have a soft blue glass-like feel, using a mixture of 2D and 3D and a simple
2 tone colour system to give them more depth. They suit a range of colour schemes,
but often work best against lighter desktops and wallpapers. 

The basics of this set were primarily designed within Photoshop, and then brought
into Microangelo for the main icon construction and smaller details.
